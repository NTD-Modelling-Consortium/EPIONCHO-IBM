...
prob_of_failing_all_re_runs = prob_of_one_test_fail**re_runs

prob_of_one_all_tests_failing = 1 - (1 - prob_of_failing_all_re_runs) ** n_tests
...
print("Probability of one test failing: ", prob_of_one_all_tests_failing)
